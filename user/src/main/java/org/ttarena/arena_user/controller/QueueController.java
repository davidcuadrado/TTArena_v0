...
import org.ttarena.arena_user.service.RedisPublisherService;
...
public class QueueController {
	...
	public QueueController(RedisPublisherService redisPublisherService) {
	...
	public Mono<QueueStatusResponse> join(@AuthenticationPrincipal ArenaUserPrincipal principal,
		...
		return redisPublisherService
				.publishUserEvent(UserEventType.USER_CONNECTED, principal.getUserId(), request.characterId())
	...
	public Mono<QueueStatusResponse> leave(@AuthenticationPrincipal ArenaUserPrincipal principal) {
		return redisPublisherService.publishUserEvent(UserEventType.USER_DISCONNECTED, principal.getUserId(), null)
