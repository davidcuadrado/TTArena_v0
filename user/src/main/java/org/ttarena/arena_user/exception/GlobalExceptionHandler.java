...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleUsernameNotFound(UsernameNotFoundException e) {
        return problem(HttpStatus.NOT_FOUND, "no-such-user", "No such user", e.getMessage());
    }
    ...
    public ResponseEntity<ProblemDetail> handleConcurrentModification(OptimisticLockingFailureException e) {
        ...
        return problem(HttpStatus.CONFLICT, "concurrent-modification", "Changed by someone else",
                "This account was changed while you were updating it. Fetch it again and retry.");
    }
